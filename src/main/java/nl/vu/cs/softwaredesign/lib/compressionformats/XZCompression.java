 ...
 */
@CompressionType(label = "XZ", description = "XZ description", extensions = { "tar.xz" })
public class XZCompression implements ICompressionFormat {
    ...
    public FileArchive compress(FileArchive fileArchive, String destinationPath) throws IOException {
        Archiver archiver = ArchiverFactory.createArchiver(ArchiveFormat.TAR, org.rauschig.jarchivelib.CompressionType.XZ);
